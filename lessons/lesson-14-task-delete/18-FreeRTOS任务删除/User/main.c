...
int main(void)
{
  ...
  USART_Config();
  Usart_SendString(DEBUG_USARTx, "lesson-14-task-delete start\r\n");
...
static void ControlTask(void *argument)
{
  ...
  while (1)
  {
    ...
    SendTaskLog("ControlTask", "delete TaskA");
    ...
    while (1)
    {
      ...
      SendTaskLog("ControlTask", "TaskA was deleted, system still running");
    }
  }
}
